...
#'
#' @export
C3Hist <- function(message, width = NULL, height = NULL, elementId = NULL) {
...
#' Shiny bindings for C3Hist
#'
#' Output and render functions for using C3Hist within Shiny
...
#' @param expr An expression that generates a C3Hist
